...
public class Quiz extends JFrame{
	...
	public void showSummary(){
		Font s=new Font("Tahoma",Font.BOLD,12);
		...
		int res=(int)(((float)(total-wrongs)/total)*100);
		try{  
    		...
    		//step4 execute query  
    		int n=stmt.executeUpdate("update quiz set resut='"+res+"' where name='"+nm+"'");  
	...
	public static void abx(String s)
	{
		nm=s;
	}
}
